...
BROWSER_SRCS := src/core/start.S src/browser/main.c src/browser/http.c src/browser/tls13_client.c src/browser/html_text.c src/browser/text_layout.c src/browser/style_attr.c src/browser/css_tiny.c src/browser/image/jpeg.c src/browser/image/png.c src/browser/image/gif.c $(TLS_SRCS) $(FONT_SRCS)
...
test: test-crypto test-net-ipv6 test-http test-http-parse test-chunked test-visible-text test-text-layout test-links test-style-attr test-spans test-css-parser test-text-font test-redirect test-jpeg-header test-png-header test-gif-header
