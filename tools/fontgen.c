...
static const struct glyph8 g_glyphs_8x8[] = {
	...
	{0xFA, {0x0C, 0x18, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3C}}, /* ú (rendered as Ú) */
	...
	{0xE6, {0x00, 0x00, 0x3E, 0x6C, 0x7E, 0x6C, 0x6E, 0x00}}, /* æ (approx as compact AE ligature) */
	{0xFD, {0x0C, 0x18, 0x66, 0x66, 0x66, 0x3C, 0x18, 0x3C}}, /* ý (rendered as Ý) */

	/* Extra symbols/Greek letters used by UTF-8 downmapping in html_text.c.
	 * These live in the unused 0x80..0x8F range.
	 */
	{0x80, {0x00, 0x00, 0x3C, 0x06, 0x3E, 0x66, 0x3E, 0x00}}, /* α */
	{0x81, {0x00, 0x00, 0x66, 0x66, 0x3C, 0x18, 0x30, 0x00}}, /* γ (approx) */
	{0x82, {0x1C, 0x36, 0x30, 0x7C, 0x30, 0x33, 0x1E, 0x00}}, /* δ (approx) */
	{0x83, {0x00, 0x00, 0x3C, 0x60, 0x7C, 0x60, 0x3C, 0x00}}, /* ε */
	{0x84, {0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x3C, 0x00}}, /* ο */
	{0x85, {0x00, 0x00, 0x7E, 0x66, 0x66, 0x66, 0x66, 0x00}}, /* π (approx) */
	{0x86, {0x00, 0x00, 0x3E, 0x60, 0x3C, 0x06, 0x7C, 0x00}}, /* σ (approx) */
	{0x87, {0x00, 0x00, 0x66, 0x66, 0x66, 0x3C, 0x18, 0x30}}, /* υ (approx) */
	{0x88, {0x00, 0x00, 0x18, 0x18, 0x18, 0x18, 0x0C, 0x00}}, /* ι */
	{0x89, {0x00, 0x00, 0x66, 0x6C, 0x78, 0x6C, 0x66, 0x00}}, /* κ */
	{0x8A, {0x00, 0x30, 0x30, 0x18, 0x0C, 0x66, 0x66, 0x00}}, /* λ (approx) */
	{0x8B, {0x18, 0x18, 0x7E, 0x18, 0x18, 0x18, 0x00, 0x00}}, /* † */
	{0x8C, {0x00, 0x00, 0x00, 0x00, 0x00, 0x36, 0x36, 0x6C}}, /* „ */
	{0x8D, {0x00, 0x00, 0x3C, 0x60, 0x60, 0x3C, 0x18, 0x30}}, /* ς (final sigma, approx) */
